...
def crop_transform(image: Image.Image, upper_left: tuple[int, int], lower_right: tuple[int, int]) -> Image.Image:
    """
    ...
    return image.crop((upper_left[0], upper_left[1], lower_right[0], lower_right[1]))
